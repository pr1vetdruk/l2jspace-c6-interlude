...
-- Clan Hall Changes
UPDATE `clanhall`
SET `location` = 'BeastFarm'
WHERE `id` = '63';

-- Insert new NPCs
INSERT
IGNORE INTO `npc` (`id`,`displayId`,`name`,`serverSideName`,`title`,`serverSideTitle`,`class`,`collision_radius`,`collision_height`,`level`,`sex`,`type`,`attackrange`,`hp`,`mp`,`hpreg`,`mpreg`,`str`,`con`,`dex`,`int`,`wit`,`men`,`exp`,`sp`,`patk`,`pdef`,`matk`,`mdef`,`atkspd`,`aggro`,`matkspd`,`rhand`,`lhand`,`armor`,`walkspd`,`runspd`,`faction_id`,`faction_range`,`isUndead`,`absorb_level`,`absorb_type`) VALUES
...
-- Insert new shop ids
INSERT
IGNORE INTO merchant_shopids VALUES (175003,'75003');
INSERT
IGNORE INTO merchant_shopids VALUES (275003,'75003');
INSERT
IGNORE INTO merchant_shopids VALUES (375003,'75003');

-- Insert new buy lists
DELETE
FROM `merchant_buylists`
WHERE `shop_id` like '%75003';
INSERT INTO `merchant_buylists` (`item_id`, `price`, `shop_id`, `order`, `count`, time)
VALUES (6902, 12900, 175003, 1, -1, 0),
...
-- Insert new shop ids
INSERT
IGNORE INTO merchant_shopids VALUES (175007,'75007');
INSERT
IGNORE INTO merchant_shopids VALUES (275007,'75007');
INSERT
IGNORE INTO merchant_shopids VALUES (375007,'75007');

-- Insert new buy lists
DELETE
FROM `merchant_buylists`
WHERE `shop_id` like '%75007';
INSERT INTO `merchant_buylists` (`item_id`, `price`, `shop_id`, `order`, `count`, time)
VALUES (6902, 12900, 175007, 1, -1, 0),
