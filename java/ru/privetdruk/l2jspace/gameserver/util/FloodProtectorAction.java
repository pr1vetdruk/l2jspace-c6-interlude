...
public class FloodProtectorAction {
    ...
    private void banChat() {
        if (client.getPlayer() != null) {
            ...
            if (player.getPunishLevel() == PlayerInstance.PunishLevel.CHAT) {
            ...
            player.setPunishLevel(PlayerInstance.PunishLevel.CHAT, newChatBanTime);
        }
    }
    ...
    private void banAccount() {
        if (client.getPlayer() != null) {
            client.getPlayer().setPunishLevel(PlayerInstance.PunishLevel.ACC, config.PUNISHMENT_TIME);
    ...
    private void jailChar() {
        if (client.getPlayer() != null) {
            client.getPlayer().setPunishLevel(PlayerInstance.PunishLevel.JAIL, config.PUNISHMENT_TIME);
