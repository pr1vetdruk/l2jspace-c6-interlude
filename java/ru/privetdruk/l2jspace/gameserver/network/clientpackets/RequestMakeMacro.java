...
public class RequestMakeMacro extends GameClientPacket {
    ...
    protected void readImpl() {
        ...
        final Macro.MacroCmd[] commands = new Macro.MacroCmd[count];
    ...
    protected void runImpl() {
        ...
        // Security Check
        for (Macro.MacroCmd command : _macro.commands) {
    ...
    private boolean checkSecurityOnCommand(Macro.MacroCmd cmd) {
        // not more then 2x ;
