        ...
        if (Config.USE_SAY_FILTER) {
            ...
            if (!filteredText.equalsIgnoreCase(_text)) {
                if (Config.CHAT_FILTER_PUNISHMENT.equalsIgnoreCase("chat")) {
                    player.setPunishLevel(PlayerInstance.PunishLevel.CHAT, Config.CHAT_FILTER_PUNISHMENT_PARAM1);
                    ...
                    player.setPunishLevel(PlayerInstance.PunishLevel.JAIL, Config.CHAT_FILTER_PUNISHMENT_PARAM1);
                }
