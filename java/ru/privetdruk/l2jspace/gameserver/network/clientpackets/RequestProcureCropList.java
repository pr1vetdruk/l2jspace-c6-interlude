...
import ru.privetdruk.l2jspace.gameserver.model.actor.instance.ManorManagerInstance;
...
public class RequestProcureCropList extends GameClientPacket {
    ...
    protected void runImpl() {
        ...
        for (int i = 0; i < _size; i++) {
            ...
            try {
                final CastleManorManager.CropProcure crop = CastleManager.getInstance().getCastleById(manorId).getCrop(itemId, CastleManorManager.PERIOD_CURRENT);
