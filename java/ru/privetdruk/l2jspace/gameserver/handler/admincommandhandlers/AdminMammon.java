...
public class AdminMammon implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, PlayerInstance activeChar) {
        ...
        final AutoSpawn.AutoSpawnInstance blackSpawnInst = AutoSpawn.getInstance().getAutoSpawnInstance(SevenSigns.MAMMON_BLACKSMITH_ID, false);
        final AutoSpawn.AutoSpawnInstance merchSpawnInst = AutoSpawn.getInstance().getAutoSpawnInstance(SevenSigns.MAMMON_MERCHANT_ID, false);
