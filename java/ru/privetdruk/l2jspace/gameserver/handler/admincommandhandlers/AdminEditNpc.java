...
import ru.privetdruk.l2jspace.gameserver.model.DropCategory;
import ru.privetdruk.l2jspace.gameserver.model.DropData;
...
public class AdminEditNpc implements IAdminCommandHandler {
    ...
    private void Show_Npc_Property(PlayerInstance activeChar, NpcTemplate npc) {
        ...
        if (content != null) {
            ...
            adminReply.replaceAll("%npcId%", String.valueOf(npc.getNpcId()));
            adminReply.replaceAll("%templateId%", String.valueOf(npc.getDisplayId()));
            adminReply.replaceAll("%name%", npc.getName());
            adminReply.replaceAll("%serverSideName%", npc.isServerSideName() ? "1" : "0");
            adminReply.replaceAll("%title%", npc.getTitle());
            adminReply.replaceAll("%serverSideTitle%", npc.isServerSideTitle() ? "1" : "0");
            adminReply.replaceAll("%collisionRadius%", String.valueOf(npc.getCollisionRadius()));
            adminReply.replaceAll("%collisionHeight%", String.valueOf(npc.getCollisionHeight()));
            adminReply.replaceAll("%level%", String.valueOf(npc.getLevel()));
            adminReply.replaceAll("%sex%", npc.getSex());
            adminReply.replaceAll("%type%", npc.getType());
            adminReply.replaceAll("%attackRange%", String.valueOf(npc.getBaseAtkRange()));
            adminReply.replaceAll("%hp%", String.valueOf(npc.getBaseHpMax()));
            adminReply.replaceAll("%mp%", String.valueOf(npc.getBaseMpMax()));
            adminReply.replaceAll("%hpRegen%", String.valueOf(npc.getBaseHpReg()));
            adminReply.replaceAll("%mpRegen%", String.valueOf(npc.getBaseMpReg()));
            adminReply.replaceAll("%str%", String.valueOf(npc.getBaseSTR()));
            adminReply.replaceAll("%con%", String.valueOf(npc.getBaseCON()));
            adminReply.replaceAll("%dex%", String.valueOf(npc.getBaseDEX()));
            adminReply.replaceAll("%int%", String.valueOf(npc.getBaseINT()));
            adminReply.replaceAll("%wit%", String.valueOf(npc.getBaseWIT()));
            adminReply.replaceAll("%men%", String.valueOf(npc.getBaseMEN()));
            adminReply.replaceAll("%exp%", String.valueOf(npc.getRewardExp()));
            adminReply.replaceAll("%sp%", String.valueOf(npc.getRewardSp()));
            adminReply.replaceAll("%pAtk%", String.valueOf(npc.getBasePAtk()));
            adminReply.replaceAll("%pDef%", String.valueOf(npc.getBasePDef()));
            adminReply.replaceAll("%mAtk%", String.valueOf(npc.getBaseMAtk()));
            adminReply.replaceAll("%mDef%", String.valueOf(npc.getBaseMDef()));
            adminReply.replaceAll("%pAtkSpd%", String.valueOf(npc.getBasePAtkSpd()));
            adminReply.replaceAll("%aggro%", String.valueOf(npc.getAggroRange()));
            adminReply.replaceAll("%mAtkSpd%", String.valueOf(npc.getBaseMAtkSpd()));
            adminReply.replaceAll("%rHand%", String.valueOf(npc.getRhand()));
            adminReply.replaceAll("%lHand%", String.valueOf(npc.getLhand()));
            adminReply.replaceAll("%armor%", String.valueOf(npc.getArmor()));
            adminReply.replaceAll("%walkSpd%", String.valueOf(npc.getBaseWalkSpd()));
            adminReply.replaceAll("%runSpd%", String.valueOf(npc.getBaseRunSpd()));
            adminReply.replaceAll("%factionId%", npc.getFactionId() == null ? "" : npc.getFactionId());
            adminReply.replaceAll("%factionRange%", String.valueOf(npc.getFactionRange()));
            adminReply.replaceAll("%isUndead%", npc.isUndead() ? "1" : "0");
            adminReply.replaceAll("%absorbLevel%", String.valueOf(npc.getAbsorbLevel()));
        } else {
    ...
    private void save_npc_property(PlayerInstance activeChar, String[] commandSplit) {
        ...
        try {
            ...
            switch (statToSet) {
                ...
                case "type": {
                    Class.forName("ru.privetdruk.l2jspace.gameserver.model.actor.instance." + value + "Instance");
