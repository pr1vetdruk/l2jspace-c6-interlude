        ...
        switch (command) {
            ...
            case "admin_manor_reset": {
                ...
                if (castleId > 0) {
                    ...
                    castle.setCropProcure(new ArrayList<CastleManorManager.CropProcure>(), CastleManorManager.PERIOD_CURRENT);
                    castle.setCropProcure(new ArrayList<CastleManorManager.CropProcure>(), CastleManorManager.PERIOD_NEXT);
                    castle.setSeedProduction(new ArrayList<CastleManorManager.SeedProduction>(), CastleManorManager.PERIOD_CURRENT);
                    castle.setSeedProduction(new ArrayList<CastleManorManager.SeedProduction>(), CastleManorManager.PERIOD_NEXT);
