...
public class AdminEventEngine implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, PlayerInstance activeChar) {
        if (command.equals("admin_event")) {
            ...
            final NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
            final StringBuilder replyMSG = new StringBuilder("<html><body>");
            replyMSG.append("<center><font color=\"LEVEL\">[ L2jSpace EVENT ENGINE</font></center><br>");
    ...
    void showEventControl(PlayerInstance activeChar) {
        final NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
        final StringBuilder replyMSG = new StringBuilder("<html><body>");
        replyMSG.append("<center><font color=\"LEVEL\">[ L2jSpace EVENT ENGINE ]</font></center><br><font color=\"LEVEL\">" + GameEvent.eventName + "</font><br><br><table width=200>");
