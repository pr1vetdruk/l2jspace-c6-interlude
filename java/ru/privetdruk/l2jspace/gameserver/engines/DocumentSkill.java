...
final class DocumentSkill extends DocumentBase {
    ...
    private void makeSkills() {
        ...
        for (int i = 0; i < _currentSkill.sets.length; i++) {
            try {
                _currentSkill.currentSkills.add(i, _currentSkill.sets[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.sets[i]));
                count++;
            } catch (Exception e) {
                LOGGER.warning("Skill id=" + _currentSkill.sets[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.sets[i]).getDisplayId() + "level" + _currentSkill.sets[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.sets[i]).getLevel() + " " + e);
            }
        }
        ...
        for (int i = 0; i < _currentSkill.enchsets1.length; i++) {
            try {
                _currentSkill.currentSkills.add(count2 + i, _currentSkill.enchsets1[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets1[i]));
                count++;
            } catch (Exception e) {
                LOGGER.warning("Skill id=" + _currentSkill.enchsets1[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets1[i]).getDisplayId() + " level=" + _currentSkill.enchsets1[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets1[i]).getLevel() + " " + e);
            }
        }
        ...
        for (int i = 0; i < _currentSkill.enchsets2.length; i++) {
            try {
                _currentSkill.currentSkills.add(count2 + i, _currentSkill.enchsets2[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets2[i]));
                count++;
            } catch (Exception e) {
                LOGGER.warning("Skill id=" + _currentSkill.enchsets2[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets2[i]).getDisplayId() + " level=" + _currentSkill.enchsets2[i].getEnum("skillType", Skill.SkillType.class).makeSkill(_currentSkill.enchsets2[i]).getLevel() + " " + e);
            }
        }
    }
}
