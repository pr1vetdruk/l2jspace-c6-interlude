...
import ru.privetdruk.l2jspace.gameserver.ai.PlayerAI.IntentionCommand;
...
public class CreatureAI extends AbstractAI {
    ...
    /*
     * (non-Javadoc)
     * @see ru.privetdruk.l2jspace.gameserver.ai.AbstractAI#onIntentionMoveToInABoat(ru.privetdruk.l2jspace.gameserver.model.Location, ru.privetdruk.l2jspace.gameserver.model.Location)
     */
    @Override
    ...
    /**
     * @see AbstractAI#onIntentionActive()
     */
    @Override
