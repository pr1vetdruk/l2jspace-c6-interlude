...
import ru.privetdruk.l2jspace.gameserver.taskmanager.RespawnTaskManager;
...
public class Spawn {
    ...
    public Spawn(NpcTemplate mobTemplate) throws ClassNotFoundException, NoSuchMethodException {
        ...
        _constructor = Class.forName("ru.privetdruk.l2jspace.gameserver.model.actor.instance." + implementationName + "Instance").getConstructor(parameters);
    }
