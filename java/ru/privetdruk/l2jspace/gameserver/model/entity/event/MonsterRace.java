 ...
 */
package ru.privetdruk.l2jspace.gameserver.model.entity.event;
    ...
    public void newRace() {
        ...
        for (int i = 0; i < 8; i++) {
            try {
                ...
                _constructor = Class.forName("ru.privetdruk.l2jspace.gameserver.model.actor.instance." + template.getType() + "Instance").getConstructors()[0];
