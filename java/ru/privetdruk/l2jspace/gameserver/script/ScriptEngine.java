 ...
 */
package ru.privetdruk.l2jspace.gameserver.script;

import java.util.HashMap;
import java.util.Map;

import ru.privetdruk.l2jspace.gameserver.script.faenor.FaenorInterface;
...
public class ScriptEngine {
    ...
    protected static Parser createParser(String name) throws ParserNotCreatedException {
        ...
        {
            try {
                Class.forName("ru.privetdruk.l2jspace.gameserver.script." + name);
