 ...
 */
package ru.privetdruk.l2jspace.tools.dbinstaller;

import ru.privetdruk.l2jspace.tools.dbinstaller.console.DBInstallerConsole;
import ru.privetdruk.l2jspace.tools.dbinstaller.gui.DBConfigGUI;
...
public class LauncherLS extends AbstractDBLauncher {
    public static void main(String[] args) throws Exception {
        final String defDatabase = "l2jlogin";
