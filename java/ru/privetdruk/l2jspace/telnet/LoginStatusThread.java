 ...
 */
package ru.privetdruk.l2jspace.telnet;
...
public class LoginStatusThread extends Thread {
    ...
    public LoginStatusThread(Socket client, int uptime, String statusPW) throws IOException {
        ...
        if (isValidIP(client)) {
            ...
            _print.println("Welcome To The L2jSpace Telnet Session.");
            ...
            if (tmpLine == null) {
                ...
                _print.println("[L2jSpace Login Server]");
                _print.print("");
                _print.flush();
            }
        } else {
    ...
    public void run() {
        ...
        try {
            while ((usrCommand.compareTo("quit") != 0) && (usrCommand.compareTo("exit") != 0)) {
                ...
                } else if (usrCommand.equals("quit")) { /* Do Nothing :p - Just here to save us from the "Command Not Understood" Text */
                } else if (usrCommand.length() == 0) { /* Do Nothing Again - Same reason as the quit part */
                } else {
